/**
 * Stateful ANSI escape sequence filter that handles sequences split across buffer boundaries
 */
...
/**
 * Stateful filter for terminal title sequences that properly handles
 * escape sequences split across buffer boundaries.
 */
export class StatefulAnsiFilter {
  private buffer = '';
